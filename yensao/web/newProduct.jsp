                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="clearfix"></div>
                                        <c:if test="${requestScope.SEND_SUCCESS != null}">
                                            <br/>
                                            <div class="col-sm-12">
                                                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                                                    <span class="badge badge-pill badge-success">Success</span> ${requestScope.SEND_SUCCESS}
                                    ...
                                    <div class="x_content">
                                        <form action="MainController" novalidate>
                                            <span class="section">Product Information</span>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align">Product Id<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="ProductID" placeholder="ex. Yasuo" required="required" />
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align">Product name<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="ProductName" placeholder="ex. Yasuo" required="required" />
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <c:set value="<%=SellerDAO.getCategory()%>" var="Cate"/>
                                                <div class="col-md-6 col-sm-6">
                                                    <select name="Category" id="select" class="form-control">
                                                        <c:forEach var="cate" varStatus="counter" items="${Cate}">                                                 
                                            ...
                                            <div class="ln_solid">
                                                <div class="form-group">
                                                    <div class="col-md-6 offset-md-3">
                                                        ...
                                                        <button type='submit' name="action" value="RequestProduct" class="btn btn-primary">Submit</button>
